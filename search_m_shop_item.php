...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" href="css/bootstrap.min.css">
            ...
            <script language="JavaScript" src="js/m_shop_item.js"></script>
               ...
               <thead>
                ...
                foreach ($conn->query($sql) as $row) {
                    ...
                    echo "<tr>                
                                ...
                                <td onclick=\"getForm('$REF','$IDF');\">" . $row['city'] . "</a></td>
                                <td onclick=\"getForm('$REF','$IDF');\">" . $row['vendor_name'] . "</a></td>
                                <td onclick=\"getForm('$REF','$IDF');\">" . $row['phone_number_1'] . "</a></td>
                                <td onclick=\"getForm('$REF','$IDF');\">" . $row['email_address'] . "</a></td>
                                <td onclick=\"getForm('$REF','$IDF');\">" . $row['sys_time'] . "</a></td>
